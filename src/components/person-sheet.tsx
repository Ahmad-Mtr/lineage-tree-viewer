...
import { personName, personFirst, personPlace, t } from "@/lib/i18n"
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {ar ? "الجيل" : "Gen"} {person.gen} · {personPlace(person, lang)}
              {!person.verified && (
                <span style={{ color: "var(--amber)", marginInlineStart: 6 }}>
                  {t("unverified", lang)}
                </span>
              )}
            </div>
        ...
        {father && (
          <section>
            <div className={`section-eyebrow${ar ? "ar" : ""}`}>
              {t("father", lang)}
            </div>
            <PersonRow
              person={father}
              ...
              {ancestorChain.map((anc, i) => (
                ...
                >
                  <button
                    ...
                    onClick={() =>
                      anc.id !== person.id && onSelectPerson(anc.id)
                    }
                  >
