...
const strings = {
  ...
  showOnTree: { en: "Show on tree", ar: "إظهار على الشجرة" },
  ...
  noMatches: {
    en: "No matches. Try a partial name.",
    ar: "لا توجد نتائج. اكتب جزءاً من الاسم.",
  },
...
export const APP_SUB_AR = APP_SUBTITLE.ar
export const APP_SUB_EN = APP_SUBTITLE.en
